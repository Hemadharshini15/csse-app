/*
  ...
  1. Tables
    - messages: Store group messages
    - groups: Store study groups
    - group_members: Manage group membership
    - user_profiles: User information and preferences
    - meetings: Group video meetings

  2. Functions
    - handle_new_user: Automatically create profile for new users
    - handle_group_deletion: Cleanup when groups are deleted
    - get_user_email: Safely get user email
